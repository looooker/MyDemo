...
public class CalendarCellView extends TextView {
	...
	public void setInSelected(boolean isInSelected) {
		this.isInSelected = isInSelected;
		refreshDrawableState();
	}

	public void setOutSelected(boolean isOutSelected) {
		this.isOutSelected = isOutSelected;
		refreshDrawableState();
	}
